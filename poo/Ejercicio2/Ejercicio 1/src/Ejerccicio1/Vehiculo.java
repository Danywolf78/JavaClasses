...
public class Vehiculo {
    ...
    public Vehiculo(String marca, int cantRuedas, boolean esDeCampetencia, Boolean estaLaAlarmaEncendida,
                    String kmMaximo, String kmMinimo) {
        Marca = marca;
        this.cantRuedas = cantRuedas;
        this.esDeCompetencia = esDeCampetencia;
    ...
    public void setEsDeCampetencia(boolean esDeCampetencia) {
        this.esDeCompetencia = esDeCompetencia;
    }
